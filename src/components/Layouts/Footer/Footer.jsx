    ...
    <footer className="footer">
      <ul className="footer__social-list">
        {socials.map(({iconName, href}, index) => (
          <li className="footer__social-item" key={index}>
            <a className="footer__social-link" href={href} target="_blank" >
      ...
      <ul className="footer__main-list">
        <li className="footer__main-item">
          ...
          <a className="footer__social-link" href="/index.html">
            Для поставщиков</a>
        </li>
        <li className="footer__main-item">
          <a className="footer__social-link" href="/index.html">Наши документы</a>
        </li>
        <li className="footer__main-item">
          <a className="footer__social-link" href="/index.html">О производстве</a>
        </li>
        <li className="footer__main-item">
          <a className="footer__social-link" href="/index.html">Экологические стандарты</a>
        </li>
      </ul>
      <div className="footer__copyright">
        <a target="_blank" href="https://t.me/khlebov79">Сделал kirill khlebov © 2024</a>
      </div>
    </footer>
  )
}
